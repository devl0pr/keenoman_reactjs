...
import {getUserInfo, removeUserInfo} from "../../data/user";
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <div className="header__content" style={{alignItems: 'center', padding: '0px'}}>
                            <button className="header__menu" type="button" onClick={headerMenuToggle}>
                                <span></span>
                                <span></span>
                                <span></span>
                            </button>

                            <Link className="header__logo" to='/' style={{color: '#fff', fontSize: '28px'}}>
                                Keenoman
                            </Link>
                            ...
                            <div className="header__actions">
                                <form action="#" className="header__form">
                                    ...
                                    <button type="button" className="header__form-close" onClick={headerSearchToggle}>
                                ...
                                <button className="header__search" type="button" onClick={headerSearchToggle}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
                                            d="M21.71,20.29,18,16.61A9,9,0,1,0,16.61,18l3.68,3.68a1,1,0,0,0,1.42,0A1,1,0,0,0,21.71,20.29ZM11,18a7,7,0,1,1,7-7A7,7,0,0,1,11,18Z"/>
                                    </svg>
